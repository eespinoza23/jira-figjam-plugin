    ...
    const response = await axios.get(
      `https://api.atlassian.com/ex/jira/${cloudId}/rest/api/3/search/jql`,
      {
        params: {
          jql,
          maxResults: 100,
          fields: 'summary,description,issuetype,priority,assignee,customfield_10000,customfield_10016,customfield_10020,customfield_10028,story_points,status,sprint,labels,components,parent,fixVersions,reporter,updated',
        },
